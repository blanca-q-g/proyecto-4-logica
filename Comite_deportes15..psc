...
Si EsPrimeraVez=Verdadero Y RondasFinalizadas=Verdadero Entonces;
	...
	Para i=0 Hasta CantRondas-1 Hacer
		Para j=0 Hasta CantPart-1 Hacer
				...
				Si EsNumero(Matriz_Competencia[i,j])=Verdadero Y SegundoLugar=0 Entonces
					SegundoLugar=ConvertirANumero(Matriz_Competencia[i,j]);
				FinSi
				
				
				Si EsNumero(Matriz_Competencia[i,j])=Verdadero Y TercerLugar=0 Entonces
	...
	Para i=0 Hasta CantRondas-1 Hacer
		...
		Para j=0 Hasta CantPart-1 Hacer 
			...
			Si Subcadena(Matriz_Ganadores[i,Contador],0,1)<>"" Entonces
				Escribir "Valor ", Subcadena(Matriz_Ganadores[i,Contador],0,1);
			FinSi
			
			Si EsNumero(Matriz_Competencia[i,j])=Verdadero Entonces
				
				Si j=PrimerLugar Entonces
					...
					Si PuntuacionMayor1>ConvertirANumero(Matriz_Ganadores[i,Contador]) Entonces
