...
SubProceso Inicio_Matriz(CantRondas Por Referencia, CantPart Por Referencia)
	...
	Para i=0 Hasta CantRondas Hacer
		Para j=0 Hasta CantPart Hacer
				...
				Escribir Matriz_Competencia[CantRondas, CantPart];
				
				Matriz_Competencia[i, j]=0;
	...
	Segun OpcionMenu Hacer
		...
		1: //Inicialización de la Matriz_Competencia
			...
			Si EsPrimeraVez=Falso entonces
				...
				Dimension Matriz_Competencia[CantRondas, CantPart];
				Matriz_Competencia[CantRondas-1, CantPart-1]=0;
				
				Inicio_Matriz(CantRondas, CantPart);
